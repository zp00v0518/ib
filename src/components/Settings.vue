<template>
  <div class="settings">
    ...
    <button class="settings__btn" @click="setSettings">Применить настройки</button>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      fields: [
        { name: 'Стартовый капитал', value: 3000, code: 'curCash' },
        { name: 'Длина портфеля', value: 15, code: 'maxLengthPortfolio' },
        {
        ...
        { name: 'Лимитная цена акции', value: 0.01, code: 'minPriceStock' },
